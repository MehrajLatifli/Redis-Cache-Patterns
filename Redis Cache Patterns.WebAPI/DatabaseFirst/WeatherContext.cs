...
namespace LazyLoading_Pattern_WebAPI.DatabaseFirst
{
    public partial class WeatherContext : DbContext
    {
        ...
        {
            string connection = @"Data Source=DESKTOP-R20UQK6;Initial Catalog=Weather;User ID=sa;Password=admin1234; Integrated Security=True; ApplicationIntent=ReadWrite; MultipleActiveResultSets = True; Trusted_Connection=True; Trusted_Connection=True; TrustServerCertificate=True;";
